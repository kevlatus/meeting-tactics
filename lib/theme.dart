...
class KevlatusColors {
  ...
  static const MaterialColor gold = MaterialColor(_goldPrimaryValue, <int, Color>{
    50: Color(0xFFFCF3E7),
  ...
  static const MaterialColor goldAccent = MaterialColor(_goldAccentValue, <int, Color>{
    100: Color(0xFFFFFFFF),
  ...
  static const MaterialColor blueDark = MaterialColor(_blueDarkPrimaryValue, <int, Color>{
    50: Color(0xFFF3F8FE),
  ...
  static const MaterialColor blueDarkAccent = MaterialColor(_blueDarkAccentValue, <int, Color>{
    100: Color(0xFFFFFFFF),
